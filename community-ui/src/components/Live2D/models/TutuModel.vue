...
const modelConfig = {
  path: '/live2d/tutu/tutu.model3.json',
  scale: 0.07,
  greeting: "你好呀，我是兔兔，很高兴见到你！"
};
...
const initLive2D = async () => {
  try {
    ...
    // 计算并设置模型位置
    const xPos = canvasWidth - model.width * modelConfig.scale * 12.7;
    const yPos = canvasHeight - model.height * modelConfig.scale * 11.3;
