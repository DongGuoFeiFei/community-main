  ...
  <div class="chat-view">
    ...
    <div class="bg-decoration">
      ...
      <div class="floating-hearts">
        <span class="heart" v-for="i in 6" :key="i" :style="{animationDelay: `${i * 0.5}s`}">♡</span>
      </div>
    </div>
...
.chat-view {
  ...
  .bg-decoration {
    ...
    .floating-hearts {
      ...
      .heart {
        ...
        &:nth-child(2) { left: 75%; top: 15%; }
        &:nth-child(3) { left: 45%; top: 70%; }
        &:nth-child(4) { left: 85%; top: 50%; }
        &:nth-child(5) { left: 25%; top: 80%; }
        &:nth-child(6) { left: 65%; top: 85%; }
      }
    }
  }
  ...
  .chat-container {
    ...
    box-shadow: 0 12px 48px rgba(179, 157, 219, 0.25), 0 0 0 1px rgba(179, 157, 219, 0.1);
    ...
    .sidebar {
      ...
      background: linear-gradient(180deg, rgba(232, 234, 246, 0.5) 0%, rgba(255, 255, 255, 0.3) 100%);
