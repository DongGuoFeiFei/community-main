...
public class ReportRecord {
    ...
    private ActiveTypeEnum contentType;
    ...
    public ReportRecord(Long reporterId, Long contentId, ActiveTypeEnum contentType, ReportTypeEnum reportType, String description) {
